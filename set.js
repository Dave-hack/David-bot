...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~Cq5SXDYD#ekD-iUQmFYS3AxTpkxjM8Ji5mm0bvZmiIXDuKz40QMI", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "50942818561", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "~KIYOTAKA AYANOKŌJI~", // Input Yours custom...(Maintain font for Flow)
...
ANTIDELETE: process.env.ANTIDELETE || "true", // Still under development
...
BOT_NAME: process.env.BOT_NAME || "*AYANOKŌJI*-𝐌𝐃", // Input Yours custom...(Maintain font for Flow)
...
TIME_ZONE: process.env.TIME_ZONE || "America/Haiti", // Enter yours else leave blank if not sure
};
